...
> 📖 **研究室メンバー向けの「使い方ガイド」はこちら → [docs/MANUAL.md](docs/MANUAL.md)**
...
- **集計期間**：4月1日〜翌年1月31日（10ヶ月）。起動時の日付から年度を自動判定し、**毎年4月に自動で次年度へ切り替わります**（累計・目標もリセット）。
- **複数年度対応**：ヘッダーの「年度」セレクタで過去の年度をいつでも閲覧・編集できます。閲覧モード中も、出退勤ボタンは常に現在の日時で記録されます。
